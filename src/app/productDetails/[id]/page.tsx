...
// import { ProductDetailsProps } from "../../productDetails/[id]/ProductDetails.types"
...
//       <div className="grid grid-cols-1 md:grid-cols-2 gap-10 bg-green-100 shadow-lg rounded-2xl p-6 md:p-10">
...
//                 <div className="flex items-center gap-2">
//                   <img
//                     src={specifiedProduct.category.image}
//                     alt={specifiedProduct.category.name}
...
//                 ({specifiedProduct.ratingsAverage} rating)
//               </span>
//             </div>
