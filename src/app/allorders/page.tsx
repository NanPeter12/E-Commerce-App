...
export default async function AllOrdersPage() {
  ...
  // FIX: Cast the session result to 'any' to allow safe access to the custom 'id' property, 
  // which is typically added during NextAuth callbacks but missing from the default types.
